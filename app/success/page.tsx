        ...
        <div className="flex flex-col items-center justify-start pt-8 lg:pt-0 lg:justify-center lg:min-h-[600px] px-4 sm:px-6">
          ...
          <div className="bg-linear-to-br from-indigo-900/40 to-slate-900/40 rounded-xl p-6 lg:p-8 mb-6 lg:mb-8 border border-indigo-500/30 w-full max-w-md backdrop-blur-md">
             <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <p className="text-indigo-200 font-semibold uppercase tracking-wide text-base lg:text-base">Next Booking Opens</p>
             </div>
             <p className="text-2xl lg:text-3xl font-bold text-white mt-1 lg:mt-2 text-center">
                {nextDate}
             </p>
          </div>
